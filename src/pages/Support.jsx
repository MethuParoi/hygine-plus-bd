      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <section className="flex flex-col lg:flex-row gap-10 items-center mb-12">
          ...
          >
            ...
            At Hygiene Plus, we prioritize customer satisfaction by providing reliable support at every step. Our dedicated team is always ready to assist with product inquiries, orders, and after-sales service to ensure a seamless shopping experience. Whether you need guidance in choosing the right products or assistance with installation and maintenance, we are here to help.

For any support, feel free to reach out—we're committed to delivering exceptional service and ensuring a hassle-free experience for our valued customers.
            </p>
          </motion.div>
          <motion.div
            className="lg:w-1/2"
...
>
  <div className="text-center mb-12">
    <h3 className="text-3xl md:text-5xl font-bold text-gray-900 mb-2">Support We Provide</h3>
    <p className="md:text-lg text-gray-700 max-w-2xl mx-auto">
      We're dedicated to providing top-notch customer support, ensuring a seamless experience at every step.
    </p>
  </div>
  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
    ...
    <div className="p-6 bg-white rounded-xl shadow-xl backdrop-blur-md bg-opacity-80 transform hover:scale-105 transition-transform duration-500">
      ...
      <p className="text-gray-700 mt-2">
        Our team is always available to answer questions and provide guidance on our products and services.
      </p>
    </div>
    {/* Support Card 2 */}
    <div className="p-6 bg-white rounded-xl shadow-xl backdrop-blur-md bg-opacity-80 transform hover:scale-105 transition-transform duration-500">
      ...
      <p className="text-gray-700 mt-2">
        We provide expert support for installation and maintenance to ensure hassle-free product usage.
      </p>
    </div>
    {/* Support Card 3 */}
    <div className="p-6 bg-white rounded-xl shadow-xl backdrop-blur-md bg-opacity-80 transform hover:scale-105 transition-transform duration-500">
      ...
      <p className="text-gray-700 mt-2">
        We ensure continued support after your purchase, helping you with any concerns or queries.
      </p>
    </div>
  </div>
</motion.section>
