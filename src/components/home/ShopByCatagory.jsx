    ...
    return (
        <div className="w-11/12 mx-auto mt-20">
            ...
            <div className="grid grid-cols-2 gap-4 items-center my-10">
                ...
                >
                    {/* Image */}
                    <img src={commodImg} alt="Premium Commod" className="rounded-lg shadow-xl" />
                    ...
                    <div className="absolute bottom-8 left-12  text-white">
                        ...
                        <p className="text-lg">
                            Bangladesh's Premier Luxury Sanitary <br /> Bathware & Kitchenware Brand
                        </p>
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="relative flex justify-center"
                    >
                        <img src={bassinImg} className="rounded-lg  bg-white shadow-[0_2px_15px_rgba(0,0,0,0.3)]" alt="Bassin Image" />
                    ...
                    <motion.div
                        ...
                        className="relative flex justify-center"
                    >
                        <img src={faucet} className="rounded-lg shadow-[0_2px_15px_rgba(0,0,0,0.3)]" alt="Faucet Image" />
                        {/* Button (Bottom of Image) */}
                        <button className="absolute bottom-16 left-1/2 transform -translate-x-1/2 bg-white shadow-[0_2px_15px_rgba(0,0,0,0.4)] px-10 py-2 rounded-full text-black  cursor-pointer transition-transform duration-300 text-xl hover:scale-105">
                            Explore
                        </button>
            ...
            <div className="grid grid-cols-2 gap-4 items-center my-10">
                ...
                >
                    ...
                    {/* Button (Top of Image) */}
                    <button className="absolute top-40 left-1/2 transform -translate-x-1/2 bg-white shadow-[0_2px_15px_rgba(0,0,0,0.4)] px-10 py-2 rounded-full text-black 
