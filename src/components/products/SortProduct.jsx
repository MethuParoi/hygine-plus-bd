...
function SortProduct() {
  ...
  return (
    <div className="mt-10">
      ...
      <div className="xl:border-t-2 border-gray-300 md:mr-[2rem] pt-[2rem] flex flex-row gap-x-2 flex-wrap lg:gap-x-0 lg:flex-col gap-y-2 lg:gap-y-6 justify-center items-center">
